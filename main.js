let { saveToMedia, fetchV2, saveFrom, uploadImage, uploadFile, uploadImgbb, ssweb, webp2mp4, webp2png, getEmoji, getEmojiV2, yt, yta, ytv, servers, igstalk, tiktokstalk, joox, gdrive, mediafire, textpro, photooxy, ephoto360, google, lyrics, chord, wikipedia, kbbi, searchRecipes, shortLink, shortBitly, getAnimeInfo, genMath, modes, encryptHtml, encryptScript, escapeFull, getZodiac, toBase64, toHex, toBinary, decodeString, randomString, reverseText, stylizeText, tts, running, tahta, searchGempa, getBuffer, textWrap, arrayRegex, pickRandom, formatSize, formatDate, parseUptime, pad, clockString, countDown, parseCookie, setDelay, isNumber, isURL, isBase64, isHex, isBinary, capitalize, replaceAll } = require('./lib/js/functions.js')
