...
function runScript() {
 ...
 div.innerHTML = `<h3>Server Bot sedang Online!<br>${times}<br><br><br>Chat dengan <a href="https://wa.me/62895337278647?text=!menu" target="_blank">Bot</a><br>Download <a href="${dl_link}" target="_blank">AutoResponder (MOD)</a></h3>`;
